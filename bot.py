...
def get_welcome_message(guild, members):
    ...
    welcome_message = welcome_message + \
        ...
        f'Feel free to use __**The Pissing Yawa**__ (https://app.roll20.net/join/5530304/i5F18w) as a character vault. Just ask any of our ~~overlords~~, I mean, {role_admin.mention} and {role_dm.mention}, to make a folder for you and/or import your character/s from other Roll20 rooms.'
